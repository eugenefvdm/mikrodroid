/**
 * (C) Copyright 2011 MikroDroid
 * 
 * @author Janisk
 * Adapted for Android by Eugene and Johan
 * 
 * ReadCommand.java
 * 
 */
...
/**
 * ReadCommand implements Runnable
 * @author eugene
 *
 */
public class ReadCommand implements Runnable {
	 ...
	 * @param queue - Data output interface
	 */
	public ReadCommand(DataInputStream in, LinkedBlockingQueue<String> queue) {
		this.in = in;
		this.queue = queue;
	}
